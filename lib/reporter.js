...
class Reporter{
	...
	constructor(runner, options){
		...
		if(Reporter.editorSettings){
			...
			if(ed.fontFamily) s.fontFamily = ed.fontFamily;
			if(ed.fontSize)   s.fontSize   = ed.fontSize + "px";
			if(ed.lineHeight) s.lineHeight = ed.lineHeight;
			if(ed.tabLength)  s.tabSize    = ed.tabLength;
		}
	}
